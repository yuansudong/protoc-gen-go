...
import (
	...
	gengo "github.com/yuansudong/protoc-gen-go/gpb/cmd/protoc-gen-go/internal_gengo"
	"github.com/yuansudong/protoc-gen-go/gpb/compiler/protogen"
	"github.com/yuansudong/protoc-gen-go/internal/gengogrpc"
)
...
func main() {
	...
	importRewriteFunc := func(importPath protogen.GoImportPath) protogen.GoImportPath {
		switch importPath {
		case "context", "fmt", "math", "sync", "reflect", "os", "log":
			return importPath
		}
