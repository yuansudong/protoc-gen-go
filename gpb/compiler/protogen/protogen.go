...
import (
	...
	"github.com/yuansudong/protoc-gen-go/gpb/encoding/prototext"
	...
	"github.com/yuansudong/protoc-gen-go/gpb/reflect/protodesc"
	...
	"github.com/yuansudong/protoc-gen-go/gpb/types/descriptorpb"
	"github.com/yuansudong/protoc-gen-go/gpb/types/pluginpb"
)
...
func (opts Options) New(req *pluginpb.CodeGeneratorRequest) (*Plugin, error) {
	...
	//
	//     option go_package = "github.com/yuansudong/protoc-gen-go/gpb/types/known/anypb";
	//
...
// For example: "github.com/yuansudong/protoc-gen-go/gpb/compiler/protogen"
