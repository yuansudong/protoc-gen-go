...
//	go build -ldflags "-X github.com/yuansudong/protoc-gen-go/gpb/reflect/protoregistry.conflictPolicy=warn"
//
...
func (r *Files) checkGenProtoConflict(path string) {
	...
	currPath := "github.com/yuansudong/protoc-gen-go/gpb/types/known/" + pkgName
	panic(fmt.Sprintf(""+
